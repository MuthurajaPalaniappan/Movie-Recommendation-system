...
tabPanel(tags$b('About'),
         ...
         tags$div(
           ...
           tags$blockquote('This project has been developed by 2019 cohort students from Krannert School of Management at Purdue University. The Movie Recommender System app lets a user search do following activities:'),
           
           tags$img(src='img1.jpeg', height = 200, width= 140),
           
           tags$img(src='img2.jpeg', height = 200, width= 140),
           
           tags$img(src='img3.jpeg', height = 200, width= 140),
           
           tags$img(src='img4.jpeg', height = 200, width= 140)
